package com.example.layanankesehatan.features.hospital.hospitaldetail
...
class HospitalDetailActivity : AppCompatActivity() {
    ...
    private fun getLocation() {
        ...
        var locationListener = object : LocationListener{
            override fun onLocationChanged(location: Location?) {
                ...
                fab_maps_hos.setOnClickListener {
    ...
    private fun initUI() {
        ...
        tv_name_hos.text = name
        tv_desc_hos.text = desc
        tv_address_hos.text = " ${district}, ${village}, ${address}"
        tv_telp_hos.text = handphone
        tv_amenities_hos.text = amenities
        Glide.with(this)
            .load(ServerConfig.HOSPITAL_PATH+image)
    ...
    private fun initIntent() {
        ...
        id = hospital.id_rumah_sakit.toString()
        name = hospital.nama_rumah_sakit.toString()
        district= hospital.kecamatan.toString()
        village = hospital.kabupaten.toString()
        address = hospital.alamat.toString()
        handphone = hospital.nomor_telp.toString()
        image = hospital.foto.toString()
        amenities = hospital.fasilitas.toString()
        desc = hospital.deskripsi.toString()
